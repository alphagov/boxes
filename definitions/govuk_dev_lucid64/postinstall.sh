...
echo "deb http://gds-packages.s3-website-us-east-1.amazonaws.com current main" > /etc/apt/sources.list.d/govuk.list
...
echo "export FACTER_govuk_class=development" >> /etc/environment
echo "export FACTER_govuk_platform=development" >> /etc/environment
